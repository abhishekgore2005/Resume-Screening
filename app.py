    ...
    for i, file in enumerate(uploaded_files):
        ...
        if enable_email and candidate_email:
            if status == "SELECTED":
                ...
                body = f"Congratulations! You scored {score}%. We invite you for an interview."
                ...
                body = f"Thank you for applying. Unfortunately, your score of {score}% did not meet our cutoff."
                if send_email(candidate_email, subj, body):
